...
%TODO: fill placeholder values from my r notebooks
...
% cibersort removed from original plan; cibersort isnt suggested by sturm2019; epic+xcell = better idea for now; suggests picking method per cell type but considering epic,xcell+cibersort as comparing would be harder if i used a separate tool for every cell type.
...
% TP53 was the most frequently mutated gene overall but did not show subtype-specific enrichment, consistent with its role as a common subtype-independent driver alteration in LUSC
...
\caption[Tumor mutational burden by subtype]{\textcolor{red}{AVOCADO; PCA with silhouette score, cum var explained by 30 PCs.}}
\label{fig:tmb_by_subtype}
\end{figure}
